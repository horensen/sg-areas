...
export enum Subzone {
  ...
  TAM_XILIN = "TAM_XIL",
  TAP_BIDADARI = "TAP_BID",
  TAP_BOON_TECK = "TAP_BOT",
  TAP_BRADDELL = "TAP_BRA",
  TAP_JOO_SENG = "TAP_JOS",
  TAP_KIM_KEAT = "TAP_KIK",
  TAP_LORONG_8_TOA_PAYOH = "TAP_L8T",
  TAP_PEI_CHUN = "TAP_PEC",
  TAP_POTONG_PASIR = "TAP_POP",
  TAP_SENNETT = "TAP_SEN",
  TAP_TOA_PAYOH_CENTRAL = "TAP_TPC",
  TAP_TOA_PAYOH_WEST = "TAP_TPW",
  TAP_WOODLEIGH = "TAP_WOO",
  TGH_TENGAH = "TGH_TEN",
  TGL_CHATSWORTH = "TGL_CHA",
  TGL_NASSIM = "TGL_NAS",
  TGL_RIDOUT = "TGL_RID",
  TGL_TYERSALL = "TGL_TYE",
  TUA_TENGEH = "TUA_TEN",
